...
while i <= end:     
    ...
    # fix 1: remove trail space
    invoice_date_str = myjson['InvoiceDate'].strip()

    # fix 2: Convert string to datetime object
    date = datetime.strptime(invoice_date_str, "%d/%m/%y %H:%M")

    # fix 3: Format the datetime object as a string in the desired format (- to remove padding)
    ...
    # print(myjson["InvoiceDate"]) # Output: {'InvoiceDate': '12/1/2010 8:26'}
